...
export const en = {
  ...
  searchResults: {
    ...
    notFoundTitle: 'No Flights Found',
    notFoundSubtitle: 'Please change your search criteria and try again.',
    sort: 'Sort by:',
    cheapest: 'Cheapest',
    fastest: 'Fastest',
  ...
  adminLogin: {
    ...
    error: 'Invalid username or password, or you do not have access.',
  },
  ...
  dashboard: {
    ...
    basicData: {
        ...
        modals: {
            ...
            classNameLabel: "Flight Class Name",
    ...
    flights: {
      ...
      form: {
        ...
        sourcingType: "Flight Sourcing Type",
        sourcingTypes: {
          CHARTER: "Charter",
        ...
        noRulesInPolicy: "No rules defined in this policy.",
      ...
      deletePolicyInUseError: "This policy cannot be deleted because it is used in at least one flight.",
      deleteError: "The flight cannot be deleted because it is associated with at least one booking."
    },
    activityLog: {
      title: "Activity Log",
      ...
      bookingSuccess: "New booking successfully created with reference number {0}.",
      bookingCancelled: "Booking No. {0} was cancelled.",
      bookingCancelledSelf: "Booking No. {0} was cancelled by user.",
      bookingStatusChanged: "Status of booking {0} changed to {1}.",
      processedRefund: "Processed refund of {0} {1} for booking {2}.",
      userRoleChanged: "Role of user {0} changed to {1}.",
      userStatusChanged: "Status of user {0} changed to {1}.",
      userBypassChanged: "Bypass rate limits permission was {0} for user {1}.",
      userPasswordReset: "Password was reset for user {0}.",
      userWalletCharged: 'User {2}\'s wallet was charged by {0} {1}.',
      commissionPaid: "Commission of {0} {1} was paid to {2} for booking {3}.",
      enabled: "enabled",
      disabled: "disabled",
      userCreated: "New user created: {0}.",
      userNameChanged: "Username of {0} changed to {1}.",
      profileNameChanged: "Changed their name from {0} to {1}.",
      profilePasswordChanged: "Changed their password.",
      ticketUpdated: "Ticket No. {0} was updated.",
      ticketReplied: "Replied to ticket No. {0}.",
      ticketCreated: 'User created a new ticket with ID {0}.',
      userRepliedToTicket: 'User replied to ticket {0}.',
      basicDataCreated: "New {0} created: {1}.",
      basicDataUpdated: "{0} updated: {1}.",
      basicDataDeleted: "{0} deleted: {1}.",
      rateLimitCreated: "Rate limit for route {0} to {1} created with price {2} {3}.",
      rateLimitUpdated: "Rate limit for route {0} to {1} updated to {2} {3}.",
      rateLimitDeleted: "Rate limit for route {0} to {1} deleted.",
      flightCreated: "New flight created: {0} ({1} - {2}).",
      flightUpdated: "Flight {0} updated.",
      flightDeleted: "Flight {0} deleted.",
      expenseCreated: "New expense recorded for {0} {1}: {2}.",
      savedPassengersAdded: 'Saved {0} new passengers to profile.',
      savedPassengerAdded: 'Saved new passenger: {0}.',
      savedPassengerUpdated: 'Updated passenger info: {0}.',
      savedPassengerDeleted: 'Deleted passenger: {0}.',
      ...
      refundAdvanced: 'Refund request for booking {0} was advanced to stage {1}.',
    },
    refunds: {
      ...
      actions: {
        approveForFinancial: 'Approve for Financial',
        approveForPayment: 'Approve for Payment',
        processPayment: 'Process Payment',
      },
      history: {
        expertReviewedBy: 'Expert reviewed by',
        financialReviewedBy: 'Financial reviewed by',
        paidBy: 'Paid by',
