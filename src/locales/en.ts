const content = {
  ...
  home: {
    ...
    popularDestinations: {
      ...
      destinationsTitle: 'Popular Destinations List',
      ...
      destinationPlaceholder: 'Enter destination name',
      imagePlaceholder: 'Enter destination image URL',
      saveDestinations: 'Save Destinations',
      cancel: 'Cancel',
      confirmDelete: 'Are you sure you want to delete this destination?',
    }
  }
};
...
export const en = {
  ...
  flightCard: {
    ...
    airline: 'Airline',
    cancelled: 'Cancelled',
    refundRulesFor: 'Refund rules for flight',
    refundPercentage: 'Refund percentage',
    cancellationFee: 'Cancellation fee',
    refundDeadline: 'Refund deadline',
    charterFlights: 'Charter flights',
    regularFlights: 'Regular flights',
    additionalFees: 'Additional fees (insurance, seat) are not refundable',
    flightNumberLabel: 'Flight Number',
    airlineLabel: 'Airline',
    routeInfo: 'Flight Route Information',
    flightDuration: 'Flight Duration',
    flightType: 'Flight Type',
    baggageInfo: 'Baggage allowance information for flight',
    handBaggage: 'Hand Baggage',
    handBaggageDetails: '1 piece up to 7kg, dimensions 55x40x20cm',
    checkedBaggage: 'Checked Baggage',
    checkedBaggageDetails: 'Allowance: {0}',
    prohibitedItems: 'Prohibited Items',
    prohibitedItemsDetails: 'Liquids over 100ml, sharp objects, flammable materials',
    additionalInfo: 'Additional Information',
    additionalInfoDetails: 'Excess baggage fees apply for additional weight',
    airlineContact: 'Airline Contact',
    airlineContactDetails: 'Contact {0} for specific baggage policies',
    routeInfoDetails: 'Route: {0} to {1}',
    visaRequirements: 'Visa Requirements',
    visaRequirementsDetails: 'Check visa requirements for {0}',
    visaProcess: 'Visa Application Process',
    visaProcessDetails: 'Apply online or at embassy/consulate',
    requiredDocuments: 'Required Documents',
    requiredDocumentsDetails: 'Passport, visa application form, photos, travel insurance',
    importantNotes: 'Important Notes',
    importantNotesDetails: 'Visa processing time varies by country',
    generalRefundPolicy: 'General Refund Policy',
    generalRefundRule1: 'Refundable up to 24 hours before departure',
    generalRefundRule2: 'Non-refundable within 24 hours of departure',
    generalRefundRule3: 'Partial refund may apply based on fare rules',
    charterFlightRefund: 'Charter Flight Refund',
    charterFlightRefundDetails: 'Subject to charter operator policies',
    systemFlightRefund: 'System Flight Refund',
    systemFlightRefundDetails: 'Subject to airline policies',
    refundProcess: 'Refund Process',
    refundProcessDetails: 'Contact customer service for refund requests',
    importantRefundNotes: 'Important Refund Notes',
    importantRefundNotesDetails: 'Refund processing time: 7-14 business days',
    refundPolicyRule1: 'Refundable up to {0} hours before departure with {1}% penalty',
    baggageAndSuitcaseRules: 'Baggage and Suitcase Rules',
    baggageInfoForFlight: 'Baggage allowance information for flight',
    handBaggageTitle: 'Hand Baggage',
    checkedBaggageTitle: 'Checked Baggage',
    allowedWeight: 'Allowed Weight',
    dimensions: 'Dimensions',
    quantity: 'Quantity',
    explosiveMaterials: 'Explosive and flammable materials',
    liquidsOver100ml: 'Liquids over 100ml',
    sharpObjects: 'Sharp and cutting objects',
    extraLithiumBatteries: 'Extra lithium batteries',
    specialItems: 'Special Items',
    liquidMedicines: 'Liquid medicines (with prescription)',
    babyFood: 'Baby food',
    medicalEquipment: 'Medical equipment',
    musicalInstruments: 'Musical instruments',
    additionalInformation: 'Additional Information',
    excessBaggageFee: 'Excess baggage can be carried with additional fee',
    rulesMayVary: 'Baggage rules may vary by destination',
    contactAirline: 'Contact airline for more information',
    valuableBaggageInsurance: 'Valuable baggage must be insured',
    baggageQuestions: 'For baggage-related questions, contact',
    visaAndRouteRules: 'Visa and Route Rules',
    visaAndRouteInfo: 'Visa and route information for',
    ...
    touristVisaForIranians: 'Tourist visa for Iranian nationals',
    transitVisaForInternational: 'Transit visa for international routes',
    businessVisaForWork: 'Business visa for work trips',
    studentVisaForStudents: 'Student visa for students',
    visaExemptions: 'Visa Exemptions',
    schengenCitizens: 'Citizens of Schengen countries',
    diplomaticPassportHolders: 'Diplomatic passport holders',
    transitLessThan24h: 'Transit passengers less than 24 hours',
    childrenUnder12WithParents: 'Children under 12 with parents',
    visaApplicationProcess: 'Visa Application Process',
    onlineApplication: 'Online Application',
    completeVisaForm: 'Complete visa application form',
    submitDocuments: 'Submit Documents',
    submitRequiredDocuments: 'Submit required documents',
    receiveVisa: 'Receive Visa',
    receiveVisaAndTravel: 'Receive visa and travel',
    mainDocuments: 'Main Documents',
    validPassport: 'Valid passport (minimum 6 months)',
    ...
    flightRouteInformation: 'Flight Route Information',
    regular: 'Regular',
    visaRulesMayChange: 'Visa rules may change - check before travel',
    contactEmbassyForAccurateInfo: 'Contact embassy for accurate information',
    receiveVisaAtLeast2WeeksBefore: 'Receive visa at least 2 weeks before travel',
    translateDocumentsToEnglish: 'Translate documents to English',
    refundTicketRules: 'Refund Ticket Rules',
    refundRulesForFlight: 'Refund rules for flight',
    informationSource: 'Information Source',
    airlineWebService: 'Airline Web Service',
    adminPanel: 'Admin Panel',
    refundRulesFromWebService: 'Refund Rules from Web Service',
    refundRule: 'Refund Rule',
    ruleDescription: 'Rule Description',
    refundConditions: 'Refund Conditions',
    defaultRefundRules: 'Default Refund Rules',
    refundTimeline: 'Refund Timeline',
    hoursBefore: 'hours before',
    fullRefund: 'Full Refund (100%)',
    refund80Percent: '80% Refund',
    refund50Percent: '50% Refund',
    refundUpTo48Hours: 'Refund up to 48 hours before: 90%',
    refundUpTo24Hours: 'Refund up to 24 hours before: 70%',
    refundUpTo12Hours: 'Refund up to 12 hours before: 50%',
    lessThan12Hours: 'Less than 12 hours: No refund',
    refundUpTo24HoursRegular: 'Refund up to 24 hours before: 100%',
    refundUpTo12HoursRegular: 'Refund up to 12 hours before: 80%',
    refundUpTo2HoursRegular: 'Refund up to 2 hours before: 60%',
    lessThan2Hours: 'Less than 2 hours: 30%',
    request: 'Request',
    submitRefundRequest: 'Submit refund request',
    review: 'Review',
    reviewRefundConditions: 'Review refund conditions',
    approval: 'Approval',
    approveRefundRequest: 'Approve refund request',
    payment: 'Payment',
    processRefundPayment: 'Process refund payment',
    discountedTicketsMayDiffer: 'Refund for discounted tickets may differ',
    additionalFeesNotRefundable: 'Additional fees (insurance, seat) are not refundable',
    refundSamePaymentMethod: 'Refund is processed using the same payment method',
    refundProcessingTime: 'Refund processing time: 7-14 business days',
    contactForRefund: 'Contact for Refund',
    contactSupportForRefund: 'Contact support for refund requests',
    ...
    delayed: 'Delayed',
    homepage: {
      heroTitle: 'Smart Travel, Unforgettable Experience',
      heroSubtitle: 'Best prices for domestic and international flights',
      oneWay: 'One Way',
      roundTrip: 'Round Trip',
      origin: 'Origin',
      ...
      whySmartFlight: 'Why Smart Flight?',
      whySmartFlightSubtitle: 'Special features for a better travel experience',
      bestPrices: 'Best Prices',
      bestPricesDesc: 'Competitive prices and special discounts for all flights',
      highSecurity: 'High Security',
      highSecurityDesc: 'Secure payment and protection of your personal information',
      support247: '24/7 Support',
      support247Desc: 'Round-the-clock support to solve your problems',
      popularDestinations: 'Popular Destinations',
      popularDestinationsSubtitle: 'Most popular travel destinations',
      fromPrice: 'From {0}',
      testPersianFlightResults: 'Test Persian Flight Results Page',
    },
  },
  passengerDetails: {
  ...
  dashboard: {
    ...
    bookings: {
      ...
      statusValues: {
        ...
        REFUNDED: 'Refunded',
        SUSPENDED: 'Suspended',
        SUSPENDED_PAYMENT_BLOCKED: 'Suspended - Payment Blocked',
        UNKNOWN: 'Unknown',
      },
      detailsModal: {
        ...
        noPassengerData: 'No passenger data available',
    ...
    permissions: {
      ...
      permissionValues: {
        ...
        MANAGE_BASIC_DATA: 'Manage Basic Data',
        ...
        BYPASS_RATE_LIMITS: 'Bypass Rate Limits',
      }
    },
    tickets: {
